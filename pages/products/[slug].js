...
const Slug = ({ addToCart ,removeFromCart ,clearCart ,subTotal ,cart}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img
        alt="ecommerce"
        className="lg:w-1/2 w-full lg:h-auto h-64 object-top object-center rounded"
        src="https://assets.ajio.com/medias/sys_master/root/20230919/B4yz/65094b2fddf7791519e6ff00/-473Wx593H-466597686-black-MODEL.jpg"
      />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button onClick={()=>addToCart(slug,499,1,"XL","wear the code")} className="flex ml-3 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">
           Add to Cart
          </button>
        ...
        <div className="pin mt-5 flex flex-wrap items-center gap-x-1">
